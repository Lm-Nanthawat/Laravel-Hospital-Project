<div class="h-[12vh] space-y-8 shadow-md shadow-[#e3eef9] Navbar-main">

    {{-- Topbar --}}
    <div class="hidden md:flex w-[76.5%] m-auto topbar-box">
        <div class="topbar">
    ...
    {{-- Navbar --}}
    <div class="w-[78%] m-auto navbar-box">
        <div class="flex justify-between items-center gap-x-20 navbar">

            {{-- Navbar Content --}}
            <div class="flex items-center">

                    {{-- Bangkok Hospital Logo --}}
                    <a class="sm:flex lg:hidden xl:flex w-[250px] logo" href="/">
                        <img class="w-[250px]" src="https://www.bangkokhospitalchanthaburi.com/images/logo.png" alt="Bangkok-hospital-logo">
                    </a>

                    {{-- Navbar Menu List --}}
                    <ul class="space-x-12 text-[#223851] text-base font-[530] pl-8 flex items-center whitespace-nowrap">
                        {{-- Home Menu --}}
